...
Since Java 9, we can fortunately skip compilation at first stage and go directly to run .java file:
...
Since JDK 9, it is possible to execute simple Java code without file creation and compilation step. Once created or executed,
