...
description: OSI model explained
...
<figure>
<img src="/assets/images/TCPIP_Model.jpg"  alt="TCP_IP model scheme" title="TCP / IP vs OSI" style="display: block; margin: auto;">
<figcaption style="text-align: center; font-style: italic">TCP / IP model vs OSI model: comparison of layers. 
Source: Ardika6879 / Wikipedia. Licensed under the Creative Commons Attribution-Share Alike 4.0 International license.</figcaption>
</figure>
...
<figure>
<img src="/assets/images/Osi-model.png"  alt="OSI model scheme" title="OSI model" style="display: block; margin: auto;">
...
Source: Dino.korah / Wikipedia. GNU Free Documentation License.</figcaption>
</figure>
