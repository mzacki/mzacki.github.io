...
Other solutions for handling the collsions is **open addressing** and its variants. Conflicting items are not stored in the list as in the case of chainig but in normal buckets.
